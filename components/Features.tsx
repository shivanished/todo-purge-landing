...
const features = [
  {
    ...
    description: "Gemini 2.5 analyzes your code context to write detailed Linear ticket descriptions, so you don't have to."
  },
  {
    icon: GitPullRequest,
    title: "Code Context",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, idx) => (
            <div key={idx} className="p-6 rounded-2xl bg-dark-900 border border-dark-800 hover:border-brand-500/30 transition-colors group">
