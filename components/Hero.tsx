    ...
    <section className="relative pt-24 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-dark-800 border border-dark-700 text-xs font-medium text-brand-400 mb-8 animate-fade-in-up">
          ...
          Now supporting Linear & Gemini 2.5
        </div>
        ...
        <p className="text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed">
          The CLI tool that scans your codebase, uses AI to write perfect ticket
          descriptions, and cleans up your technical debt—all without leaving
          the terminal.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full max-w-md mx-auto mb-16">
          ...
          <Button
            size="lg"
            className="w-full sm:w-auto min-w-[160px] whitespace-nowrap"
